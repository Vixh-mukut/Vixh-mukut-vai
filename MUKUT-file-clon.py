...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Vixh-mukut/Approval./blob/main/Raz.txt').text
    if id in httpCaht:
      print(fuckyoursali)
...
os.system('espeak -a 300 " Welcome,   to,  MUKUT  VAI  V I P,  Tools"')
def back():
	login()
...
while attemps < 12345677901:
    ...
    if username == 'MT' and password == '68':
        print('\033[0;92mYou Have Successfully Logged in.')
        break
    else:
        print('\033[0;92mIncorrect Pass Please Trying ')
        attemps += 1
        continue
os.system('clear')
pass
...
def menu():
    ...
    if MUKUT in ['111']:
        ...
        os.system('xdg-open https://github.com/Vixh-mukut')
        os.system("python nono.py")
    elif MUKUT in ['3','03']:
        result()
    elif MUKUT in ['0']:
